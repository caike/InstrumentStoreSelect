...
config :instrument_store_select,
  ecto_repos: [InstrumentStoreSelect.Repo]
...
config :instrument_store_select, InstrumentStoreSelectWeb.Endpoint,
  ...
  live_view: [signing_salt: "Ux5vAk1X"]
...
config :instrument_store_select, InstrumentStoreSelect.Mailer, adapter: Swoosh.Adapters.Local
